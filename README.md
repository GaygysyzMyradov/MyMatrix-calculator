...
methods.
iii) Setters: setRow, setColumn & setArray
...
object.
v) Getters: getElements, getDimension
...
1. matrixAddition: This method is used to Add two Matrices. The method accepts
...
2. matrixSubtraction: This method is used to Subtract two Matrices. The method
...
Message.
3. matrixMultiplication: This method is used to Multiple two Matrices as its name
...
4. matrixDivision: This method is used to Divide two Matrices. The method accepts
...
array, else, it will Print an error Message.vii) Main Class
